"""Unitree G1 transition-v3 environment configuration.

Applies G1-specific overrides on top of the base transition-v3 environment,
mirroring the same pattern as the v2 G1 override.
"""
...
def unitree_g1_transition_v3_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Unitree G1 transition-v3 configuration."""
