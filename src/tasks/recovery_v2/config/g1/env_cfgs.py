"""Unitree G1 recovery-v2 environment configuration.

Applies G1-specific overrides on top of the base recovery-v2 environment,
following the same pattern as recovery-v1.
"""
...
from src.tasks.recovery_v2.recovery_v2_env_cfg import make_recovery_v2_env_cfg


def unitree_g1_recovery_v2_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
    """Create Unitree G1 recovery-v2 configuration."""
    cfg = make_recovery_v2_env_cfg()
    ...
    # history_length=4 ensures transient contacts during rolling/flipping are
    # penalised.  Side-lying recovery involves more body contact than v1.
